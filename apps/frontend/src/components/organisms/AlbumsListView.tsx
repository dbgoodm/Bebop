      ...
      {albums.map((album) => {
        ...
        return (
          <div
            ...
            className="bg-[#0c1017] border border-neutral-800 hover:border-neutral-700 rounded-lg overflow-hidden transition-all duration-200"
          >
            {/* Header row */}
            <div
            ...
            >
              ...
              <div className="flex items-center gap-3.5 min-w-0">
                <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-md overflow-hidden bg-neutral-900 shrink-0 shadow-sm">
                  {album.coverUrl ? (
                    <img
                      src={album.coverUrl}
                      alt={album.title}
                  ...
                  >
                    <div className="w-8 h-8 rounded-full bg-amber-500 text-black flex items-center justify-center shadow-md">
                ...
                <div className="truncate">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span className="px-1.5 py-0.2 rounded text-[10px] font-mono bg-amber-950/80 text-amber-300 border border-amber-600/40">
                      {album.format}
                    </span>
              ...
              <div className="flex items-center gap-4 shrink-0">
                ...
                <button
                  ...
                  className="w-8 h-8 rounded border border-neutral-800 bg-[#080b10] text-neutral-400 hover:text-white flex items-center justify-center transition-colors"
                ...
                <div className="divide-y divide-neutral-900/60">
                  {album.tracks.map((t) => (
                    <div
                      ...
                      className="py-2 px-2 flex items-center justify-between text-xs text-neutral-300 hover:bg-[#111722] hover:text-white rounded transition-colors cursor-pointer group"
                    >
                      ...
                      <div className="flex items-center gap-3 font-mono text-[11px] text-neutral-500 shrink-0">
                        ...
                        <button
                          ...
                          className="w-6 h-6 rounded bg-neutral-800 text-neutral-300 group-hover:bg-amber-500 group-hover:text-black flex items-center justify-center transition-colors"
